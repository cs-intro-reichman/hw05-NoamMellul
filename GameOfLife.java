...
public class GameOfLife {
	...
	private static void test2(String fileName) {
		...
		for(int i = 1; i < m - 1; i++) {
			for (int j = 1; j < n - 1; j++) {
				System.out.println("the number of living neighbors" + count(board, i, j));
				System.out.println("the cell value should have in the next generation" + cellValue(board, i, j));
			}
		}
	}
